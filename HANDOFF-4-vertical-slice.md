...
Continues from `HANDOFF.md`, `HANDOFF-2-hasura.md`, `HANDOFF-3-control-plane.md`.

## Goal

Close the two open questions left by HANDOFF-2 by provisioning **one** agent
...
HANDOFF-2's biggest open risk was DNS: can the host hasura **container** reach
...
## What this unblocks for the control plane (HANDOFF-3)
...
- ~~Real data isolation for the backend's **direct** DB layer (not just hasura):
  ...
  **RESOLVED (HANDOFF-6, 2026-06-12):** agent .env is generated by the control
